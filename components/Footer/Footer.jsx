    ...
    return (
        <div className='bg-[#eee]'>
            <div className="max-w-screen-xl mx-auto px-3">
                <div className="grid grid-cols-4 gap-4 md:justify-between px-2 sm:px-4 py-2.5 w-full z-20 left-0">
                    <div><div className="mb-6 md:mb-0">
                        <div>
                            ...
                            <ul className="text-gray-600 dark:text-gray-400">
                                <li className="mb-4">
                                    <Link href="/allPages/OurStory" className="flex  hover:underline items-center">
                                ...
                                <li className="mb-4">
                                    <Link href="/allPages/ShippingAndDelivery" className="flex  hover:underline items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-4 h-4">
                                            <path strokeLinecap="round" strokeLinejoin="round" d="M11.25 4.5l7.5 7.5-7.5 7.5m-6-15l7.5 7.5-7.5 7.5" />
                                        </svg>
                                ...
                                <li className="mb-4">
                                    <Link href="/allPages/ExchangeAretunP" className="flex  hover:underline items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-4 h-4">
                                            <path strokeLinecap="round" strokeLinejoin="round" d="M11.25 4.5l7.5 7.5-7.5 7.5m-6-15l7.5 7.5-7.5 7.5" />
                                        </svg>
                                ...
                                <li className="mb-4">
                                    <Link href="/allPages/TAc" className="flex  hover:underline items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-4 h-4">
                                            <path strokeLinecap="round" strokeLinejoin="round" d="M11.25 4.5l7.5 7.5-7.5 7.5m-6-15l7.5 7.5-7.5 7.5" />
                                        </svg>
                                ...
                                <li className="mb-4">
                                    <Link href="/allPages/PrivacyPolicy" className="flex  hover:underline items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-4 h-4">
                                            <path strokeLinecap="round" strokeLinejoin="round" d="M11.25 4.5l7.5 7.5-7.5 7.5m-6-15l7.5 7.5-7.5 7.5" />
                                        </svg>
                                        Privacy Policy</Link>
                                ...
                                <li className="mb-4">
                                    <Link href="/allPages/Faq" className="flex  hover:underline items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-4 h-4">
                                            <path strokeLinecap="round" strokeLinejoin="round" d="M11.25 4.5l7.5 7.5-7.5 7.5m-6-15l7.5 7.5-7.5 7.5" />
                                        </svg>
                                        FAQs</Link>
                        ...
                        <div className="col-span-2">
                            ...
                            <div>
                                <Link href="/" className="flex justify-center">
                                    <img src="../../hometex-logo.png" className="h-auto max-w-lg" alt="Hometex Bangladesh Logo" />
                ...
                <footer className="p-4 max-w-screen-xl mx-auto px-3  sm:p-6 dark:bg-gray-900 md:justify-between  sm:px-4 w-full z-20 left-0 ">
                    ...
                    <div className="sm:flex sm:items-center sm:justify-between">
                        ...
                        <span className=""><Link href="/" className="flex">
                            <img src="../../footer_copyright.jpeg" className="h-auto max-w-lg" alt="Hometex Bangladesh Logo" />
