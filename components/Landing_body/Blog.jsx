                ...
                >
                    ...
                    <SwiperSlide className="border-black">
                        ...
                        <div className="w-full max-w-sm bg-white rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
                            <a href="#">
                                <img className="p-8 rounded-t-lg" src="../../assets/FROM OUR BLOG/inside-weather-ej3UoXYMaRI-unsplash-600x390.webp" alt="product image" />
                            </a>
                    ...
                    <SwiperSlide>
                        ...
                        <div className="w-full max-w-sm bg-white rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
                            <a href="#">
                                <img className="p-8 rounded-t-lg" src="../../assets/FROM OUR BLOG/softy-600x390.webp" alt="product image" />
                            </a>
                    ...
                    <SwiperSlide>
                        <div className="w-full max-w-sm bg-white rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
                            <a href="#">
                                <img className="p-8 rounded-t-lg" src="../../assets/FROM OUR BLOG/002 (4)-600x390.webp" alt="product image" />
                            </a>
