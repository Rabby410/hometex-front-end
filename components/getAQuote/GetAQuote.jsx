function GetAQuote() {
    return (
        <div className="max-w-screen-xl mx-auto px-3 mb-5 grid justify-items-stretch">
            <div className="w-[90%]  bg-[url('/assets/getAQuote.jpg')] justify-self-center text-[#fff]   ">
            
                <div className="w-[60%]  bg-[#afa2a229] justify-self-auto md:justify-items-center text-center m-5 p-5">
                <form>
                    <div className="mb-6">
