  ...
  return (
    ...
    <div className="grid grid-cols-2 gap-2 items-center">
      ...
      <div className="w-[80%] text-center pb-5 ">
        <div className="h-[300px] border-[5px] border-[#f3f3f3]"><Link href="/"> <img src="../../hometex-logo.png" className="h-auto max-w-lg m-5" alt="Hometex Bangladesh Logo" /></Link></div>
        <div className="h-[300px] border-[5px] border-[#f3f3f3]">
